...
def main():
    ...
    while True:
        ...
        draw_text_clamped(display_frame, f"OK: {good_count}  NG: {bad_count}", 20, 40, font_scale=1.0)
        draw_text_clamped(display_frame, "O:SaveOK  N:SaveNG  R:RedoROI  ESC:Quit",
                           20, display_frame.shape[0] - 20, font_scale=0.6)
