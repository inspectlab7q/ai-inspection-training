...
このページは、**講習前にPC側で準備しておいてほしいことだけ**をまとめたものです。
当日の使い方は [README.md](README.md) を参照してください。
...
準備はここまでです。お疲れさまでした。当日の使い方は [README.md](README.md) を参照してください。

（Raspberry Piの準備や、複数PC・複数プロジェクトを扱う場合の構成は、講師側で別途用意します）
